#include <cstdlib>
#include "../include/thermodynamic_fields.h"

int main(int argc, char **argv) {
    thermodynamic_fieldsHandle_t handle;
    int err;
    double CI = 42;
    double CL = 42;
    double CPD = 42;
    ...
    handle = __dace_init_thermodynamic_fields(I, J, K, NRR);
    __program_thermodynamic_fields(handle, cph, exn, ls, lv, rc, rg, ri, rr, rs, rv, t, th, CI, CL, CPD, CPV, I, J, K, LSTT, LVTT, NRR, TT);
    err = __dace_exit_thermodynamic_fields(handle);
