...
def aro_filter(
    exnref: dace.float64[I, J, K],
    cph: dace.float64[I, J, K],
    tht: dace.float64[I, J, K],
    ths: dace.float64[I, J, K],
    rcs: dace.float64[I, J, K],
    rrs: dace.float64[I, J, K],
    ris: dace.float64[I, J, K],
    rvs: dace.float64[I, J, K],
    rgs: dace.float64[I, J, K],
    rss: dace.float64[I, J, K],
    dt: dtype_float,
):
